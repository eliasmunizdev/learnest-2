                ...
                ?>
                                            <form action="https://secure.nmi.com/cart/cart.php" method="POST"
                                                ...
                                                <input type="hidden" name="hash"
                                                    value="action|amount|order_description|7b5fe6d97fbd304945f0ff5060e095e7" />
                                      ...
                                      if($servicio_2 != 0){
                                        ...
                                        <div class="caja-btn">
                                            ...
                                            <form action="https://secure.nmi.com/cart/cart.php" method="POST"
                                                ...
                                                <input type="hidden" name="language" value="en" />
                                                <input type="hidden" name="url_finish"
                                                    value="http://learnest-cp514.wordpresstemporal.com/admin/panel.php" />
                                                <input type="hidden" name="customer_receipt" value="true" />
                                                <input type="hidden" name="hash"
                                                    value="action|amount|order_description|2c869dbb39697e08825161e732d881f6" />
                                                <input class="btn-2 Gilroy-Bold blanco" type="submit" name="submit"
                                                    value="Pagar" />
                                            </form>
                                            <?php 
                                            ...
                                            <form action="https://secure.nmi.com/cart/cart.php" method="POST"
                                                ...
                                                <input type="hidden" name="customer_receipt" value="true" />
                                                <input type="hidden" name="hash"
                                                    value="action|amount|order_description|cb5d318784de79af8cf2f673e29bb61d" />
                                                <input class="btn-2 Gilroy-Bold blanco" type="submit" name="submit"
                                                    value="Pagar" />
                                            </form>
                                            <?php
